      ...
      <section className="py-20 sm:py-32">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          ...
          <p className="text-xl text-foreground/70">
            This page is coming soon! Continue prompting to build out the learning
            section with courses, lessons, and interactive content.
          </p>
          <div className="bg-primary/10 border border-primary/20 rounded-2xl p-8 max-w-2xl mx-auto">
            <div className="text-6xl mb-4">📚</div>
            <p className="text-foreground/70 mb-6">
              Help us build the learning section by describing the courses,
              topics, and content you'd like to include.
            </p>
            <Link to="/">
